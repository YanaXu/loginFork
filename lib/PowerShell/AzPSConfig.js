...
class AzPSConfig {
    static setPSModulePathForGitHubRunner() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (runner.toLowerCase()) {
                case "linux":
                    AzPSConfig.pushPSModulePath(AzPSConstants_1.default.DEFAULT_AZ_PATH_ON_LINUX);
                    break;
                case "windows":
                case "windows_nt":
                    AzPSConfig.pushPSModulePath(AzPSConstants_1.default.DEFAULT_AZ_PATH_ON_WINDOWS);
                    break;
                case "macos":
                case "darwin":
    ...
    static importLatestAzAccounts() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let azAccountsPath = yield AzPSConfig.runPSScript(importLatestAccountsScript);
