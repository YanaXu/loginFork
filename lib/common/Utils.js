...
const AzPSConstants_1 = __importDefault(require("../PowerShell/AzPSConstants"));
const AzPSConfig_1 = __importDefault(require("../PowerShell/AzPSConfig"));
...
function cleanupAzPSAccounts() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        AzPSConfig_1.default.setPSModulePathForGitHubRunner();
        yield AzPSConfig_1.default.importLatestAzAccounts();
